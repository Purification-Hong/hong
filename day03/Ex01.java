...
public class Ex01 {
	public static void main(String[] args) {
		...
		/*  방법) 일수를 제외한 숫자를 초 단위로 변환한다. 그런다음 초부터 짤라서 기억해 나간다.
		 
		    */ 
		//초 단위로 변환 
		//하루를 초로 변환하면 24 * 60 * 60가 된다.
		
		int tmp=(int) (calData*24*60*60); // calData가 double이므로 연산결과를 강제형변환 해야한다
